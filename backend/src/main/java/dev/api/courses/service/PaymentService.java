...
import dev.api.courses.repository.OrderRepository; 
...
public class PaymentService {
    ...
    public PaymentService(StudentsRepository studentsRepository, CoursesRepository coursesRepository,
            OrderRepository orderRepository, CourseRedisRepository courseRedisRepository, CartService cartService) {
    ...
    public void paymentSuccessAndCreateOrder(String sessionId) {
        ...
        try {
            ...
            if ("complete".equals(session.getPaymentStatus())) {
                ...
                Optional<CourseRedisEntity> cacheCourse = courseRedisRepository.findById("course_" + courseId);
