...
import dev.api.courses.dto.AddToCartRequest;
import dev.api.courses.mapper.CartCoursesResponse;
...
public class CartService {
    ...
    public void addToCart(AddToCartRequest request, String username) {
        ...
        CourseRedisEntity cacheCourse = mapToCacheCourse(course);
    ...
    private void createNewStudentWithCart(String username, CourseRedisEntity cacheCourse, BigDecimal coursePrice) {
    ...
    private void addToExistingCart(CacheStudent cacheStudent, CourseRedisEntity cacheCourse, Course course) {
        ...
        cacheCartRepository.save(cacheCart);
        // courseRedisRepository.save(cacheCourse);
    }


    private CourseRedisEntity mapToCacheCourse(Course course) {
        // CourseRedisEntity cacheCourse = new CourseRedisEntity();
    ...
    public CartCoursesResponse getCart(String username) {
        ...
        // Iterable<CourseRedisEntity> cacheCourses = courseRedisRepository.findAllById(cacheCart.getItemIds());
        
        // return new CartCoursesResponse(cacheCart.getTotalAmount(), cacheCart.getItemIds().size(), null);
        return null;
    }
